        ...
        return {
            ...
            link: function(scope, element/*, attrs*/) {
                ...
                ngTableEventsChannel.onAfterReloadData(function(pubParams) {
                    ...
                    var pageRangeStart = pubParams.count() * (pubParams.page() - 1) + 1;
                    var pageRangeEnd = pubParams.count() * pubParams.page();
                    if(pageRangeEnd > pubParams.total()) {
                        pageRangeEnd = pubParams.total();
                    }
                    scope.pageRangeStart = pageRangeStart;
...
angular.module('ngTable').run(['$templateCache', function ($templateCache) {
	...
	$templateCache.put('ng-table/pager.html', '<div class="ng-cloak ng-table-pager" ng-if="params.data.length"><div ng-if="params.settings().counts.length" class="ng-table-counts btn-group pull-right"><div style="display:inline-block; margin-top: 8px; margin-right: 20px; float: left;" ng-if="params.settings().total">Showing {{pageRangeStart}} to {{pageRangeEnd}} of {{ params.settings().total }} entries</div><button ng-repeat="count in params.settings().counts" type="button" ng-class="{\'active\':params.count()==count}" ng-click="params.count(count)" class="btn btn-default"> <span ng-bind="count"></span> </button></div><ul class="pagination ng-table-pagination"> <li ng-class="{\'disabled\': !page.active && !page.current, \'active\': page.current}" ng-repeat="page in pages" ng-switch="page.type"> <a ng-switch-when="prev" ng-click="params.page(page.number)" href="">&laquo;</a> <a ng-switch-when="first" ng-click="params.page(page.number)" href=""><span ng-bind="page.number"></span></a> <a ng-switch-when="page" ng-click="params.page(page.number)" href=""><span ng-bind="page.number"></span></a> <a ng-switch-when="more" ng-click="params.page(page.number)" href="">&#8230;</a> <a ng-switch-when="last" ng-click="params.page(page.number)" href=""><span ng-bind="page.number"></span></a> <a ng-switch-when="next" ng-click="params.page(page.number)" href="">&raquo;</a> </li> </ul> </div> ');
